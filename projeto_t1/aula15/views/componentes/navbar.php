<nav class="navbar navbar-expand-lg bg-dark navbar-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="<?= BASE_URL ?>public/imagens/logo-branco.png" height="40px" /></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?= BASE_URL ?>views/pagina_inicial.php">Início</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?= BASE_URL ?>views/sobre.php">Sobre</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?= BASE_URL ?>views/categoria_terror.php">Terror</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= BASE_URL ?>views/contato.php">Contato</a>
        </li>
      </ul>
